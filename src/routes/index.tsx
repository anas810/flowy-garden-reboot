    ...
    >
      <div className="mx-auto w-full max-w-5xl px-6 pb-24 pt-14 sm:px-10">
        ...
        <section className="mt-6 border border-hairline bg-paper sm:mt-8">
          ...
          <div className="grid grid-cols-1 items-center gap-4 px-6 py-2 sm:grid-cols-[1fr_minmax(0,1.6fr)_1fr] sm:gap-6 sm:px-10">
            {/* left column */}
            ...
            {/* center canvas */}
            <div className="relative order-1 -translate-y-8 sm:order-2">
